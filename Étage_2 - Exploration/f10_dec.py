...
def decrypt_shared_message(public_key_1, public_key_2, ciphertext_hex1, ciphertext_hex2):

    # Chargement des clés publiques
    with open(public_key_1, 'r') as f:
        pkey1 = RSA.import_key(f.read())

    with open(public_key_2, 'r') as f:
...
if __name__ == "__main__":
    public_key_1 = 'f10_westsuzanne.pem'
    public_key_2 = 'f10_tiffany72.pem'
    ...
    decrypted_message = decrypt_shared_message(public_key_1, public_key_2, ciphertext_hex_westsuzanne, ciphertext_hex_tiffany72)
